...
O objetivo do desafio é criar uma API para um Banco Digital fictício. Abaixo, estão os requisitos do desafio que foram atendidos nessa aplicação.

A missão é construir uma RESTful API que permita:
...
**Sempre que a validação de uma requisição falhar, a API responde com código de erro e mensagem adequada à situação.**
